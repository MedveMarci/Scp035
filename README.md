# Scp035 ![Downloads](https://img.shields.io/github/downloads/MedveMarci/Scp035/total) <a href="https://github.com/KenleyundLeon/DeltaPatch"><img src="https://image2url.com/images/1759565889245-ff2e02c2-1f19-4f72-bc06-43a3b77fb4bd.png"></a>
...
- Give permission ``scp035.spawn`` to your role in ``~/LabAPI/configs/permissions.yml``
- Use ``spawnscp035 id true/false`` to spawn a specific player as Scp035
